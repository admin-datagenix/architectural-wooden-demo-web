    ...
    <main className="site">
      ...
      <section id="home" className="hero">
        <div className="hero-slideshow">
          <div className={`hero-slide ${heroSlide === 0 ? "active" : ""}`}>
            <Image src="https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?auto=format&fit=crop&w=2000&q=90" alt="Hero 1" fill priority className="hero-image" />
          </div>
          <div className={`hero-slide ${heroSlide === 1 ? "active" : ""}`}>
            <Image src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=2000&q=90" alt="Hero 2" fill className="hero-image" />
          </div>
        </div>
      ...
      >
        ...
        <div className="contact-copy reveal">
          ...
          <div className="contact-links">
            ...
            <a href="mailto:hello@woodandspace.com">
              <FaEnvelope />
              hello@woodandspace.com
            </a>

            <a href="https://www.google.com/maps/search/?api=1&query=Pune%2C%20Maharashtra" target="_blank" rel="noopener noreferrer">
              <FaLocationDot />
              Pune, Maharashtra
            </a>
